...
Route::get('/anggota/hapus/{anggota}', 'AnggotaController@anggotahapus');
Route::put('/anggota/edit/{anggota}', 'AnggotaController@anggotaedit');
...
Route::get('/petugas/hapus/{petugas}', 'PetugasController@petugashapus');
...
Route::put('/pinjam/edit/{id_pinjam}', 'Pinjam@pinjamedit');